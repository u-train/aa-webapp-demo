...
export default function VerifyEmail({
    ...
    wasAccountMadeRecently: boolean;
}) {
    return (
        <>
            ...
            {wasAccountMadeRecently ? (
                <p>
                    ...
                    account. Please click it to continue to your account.
                </p>
            ) : (
                <p>
                    Your email account has not been verified yet. Please check
                    your email for the verification link.
                </p>
            )}

            <p>
                If you have not received the email or have lost it, click below
                to resend.
            </p>
